...
ostream & operator<< (ostream & wypisz, const zesp z1)
  {
    if(z1.im==0) { wypisz << "(" << z1.re << ")"; }
    else if(z1.im<0) { wypisz << "(" << z1.re << " - " << wb(z1.im) << "i)"; }
    else { wypisz << "(" << z1.re<< " + " << wb(z1.im) << "i)"; }
    return wypisz;
  }
//-----------------------------------------------------------
zesp & operator>> (istream & wpisz, zesp & z1)
  {
    char tmp;
    wpisz >> z1.re;
    if(wpisz.peek()=='+' || wpisz.peek()==',') { wpisz >> tmp; }
    wpisz >> z1.im;
    return z1;
  }
//-----------------------------------------------------------
...
bool operator== (const zesp &z1, const zesp &z2)
  {
	if(z1.re==z2.re && z1.im==z2.im) { return 1; }
	else return 0;
  }
