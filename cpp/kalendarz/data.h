...
year=(yy - (yy % 100)) / 100;
if      (year==17) {m=23;n=3;}
else if (year==18) {m=23;n=4;}
else if (year==19) {m=24;n=5;}
else if (year==20) {m=24;n=5;}
else if (year==21) {m=24;n=6;}
...
void przestepny()
{
if ( ((yy%4)==0) && ((yy%100)!=0) || ((yy%400)==0) ) p=1;
else p=0;
}
...
else d_m=((dod[0][mm]) - (dod[0][mm-1])); 

if(p)
{d_y=(dod[1][mm-1]+dd);}
else d_y=(dod[0][mm-1]+dd);
}
