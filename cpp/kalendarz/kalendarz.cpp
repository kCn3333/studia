...
cout<<"\n\t[==========================]";
cout<<"\n\t|\t"<< ((biezaca.d_t==0) ? "Niedziela":(biezaca.d_t==1) ? "Poniedzialek": (biezaca.d_t==2) 
    ? "Wtorek":(biezaca.d_t==3) ? "Sroda":(biezaca.d_t==4) 
    ? "Czwartek":(biezaca.d_t==5)? "Piatek":"Sobota");
...
////////////////////////////////////
    ...
    data1.DzienTyg();
    k=data1.d_t;
    cout <<"\t :: "<< ((k==0) ? "Niedziela":(k==1) ? "Poniedzialek": (k==2) 
        ? "Wtorek":(k==3) ? "Sroda":(k==4) 
        ? "Czwartek":(k==5)? "Piatek":"Sobota")
    << " :: ";
    break;
////////////////////////////////////
    case 2:
