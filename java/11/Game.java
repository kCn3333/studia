            ...
            try {
                ...
                while (true) {
                    ...
                    if (command.startsWith("CLEAR")) {
                    	...
                    	GomokuServer.console.append(GomokuServer.getDateTime()+" New game \n" );
                    	
                    	if(mark=='O') {
                    		output.println("MESSAGE Oponents move");
                    		...
                    		output.println("MESSAGE Your move");
                    		opponent.output.println("MESSAGE Oponents move");
                    		currentPlayer = currentPlayer.opponent;
                    ...
                    if (command.startsWith("LOAD")) {
                    	...
                    	GomokuServer.console.append(GomokuServer.getDateTime()+" "+mark+" > load\n" );
                    	board = new ArrayList<Field>();
                    	...
                    	while (command.startsWith("[")){
                            ...
                            temp.add(new Move(locX,locY,m));
                            board.add(field);

                            //output.println("Added");

                            GomokuServer.console.append(GomokuServer.getDateTime()+" move "+m+" "+locX+" "+locY+" added\n" );

                            command = input.readLine();
                    	}
                    	
                    	for(Move item : temp){
        					opponent.output.println(item);
        				}
                    	...
                    	if(m==mark) {
                    		output.println("MESSAGE Oponents move");
                    		opponent.output.println("MESSAGE Your move");
                    		if(mark==currentPlayer.mark) currentPlayer = currentPlayer.opponent;
                    	}
                    	else{
                    		output.println("MESSAGE Your move");
                    		opponent.output.println("MESSAGE Oponents move");
                    	...
                    	GomokuServer.console.append(GomokuServer.getDateTime()+" loading moves completed\n" );
                    	GomokuServer.console.append(GomokuServer.getDateTime()+" its time to "+currentPlayer.mark+" move\n" );
