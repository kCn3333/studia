...
a11=new float* [k]; for(int i=0;i<k;i++) { a11[i]=new float [k];}
a12=new float* [k]; for(int i=0;i<k;i++) { a12[i]=new float [k];}
a21=new float* [k]; for(int i=0;i<k;i++) { a21[i]=new float [k];}
a22=new float* [k]; for(int i=0;i<k;i++) { a22[i]=new float [k];}
b11=new float* [k]; for(int i=0;i<k;i++) { b11[i]=new float [k];}
b12=new float* [k]; for(int i=0;i<k;i++) { b12[i]=new float [k];}
b21=new float* [k]; for(int i=0;i<k;i++) { b21[i]=new float [k];}
b22=new float* [k]; for(int i=0;i<k;i++) { b22[i]=new float [k];}
c11=new float* [k]; for(int i=0;i<k;i++) { c11[i]=new float [k];}
c12=new float* [k]; for(int i=0;i<k;i++) { c12[i]=new float [k];}
c21=new float* [k]; for(int i=0;i<k;i++) { c21[i]=new float [k];}
c22=new float* [k]; for(int i=0;i<k;i++) { c22[i]=new float [k];}

m1=new float* [k]; for(int i=0;i<k;i++) { m1[i]=new float [k];}
m2=new float* [k]; for(int i=0;i<k;i++) { m2[i]=new float [k];}
m3=new float* [k]; for(int i=0;i<k;i++) { m3[i]=new float [k];}
m4=new float* [k]; for(int i=0;i<k;i++) { m4[i]=new float [k];}
m5=new float* [k]; for(int i=0;i<k;i++) { m5[i]=new float [k];}
m6=new float* [k]; for(int i=0;i<k;i++) { m6[i]=new float [k];}
m7=new float* [k]; for(int i=0;i<k;i++) { m7[i]=new float [k];}
h1=new float* [k]; for(int i=0;i<k;i++) { h1[i]=new float [k];}
h2=new float* [k]; for(int i=0;i<k;i++) { h2[i]=new float [k];}
...
A=new float* [n]; for(int i=0;i<n;i++) { A[i]=new float [n];}
B=new float* [n]; for(int i=0;i<n;i++) { B[i]=new float [n];}
C=new float* [n]; for(int i=0;i<n;i++) { C[i]=new float [n];}
